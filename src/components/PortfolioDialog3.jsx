...
export default function PortfolioDialog3() {
      ...
      <Laptop>
        <Box
          ...
          <Typography
            ...
            >
            A small but powerful music search tool that uses third party API's to retrieve song information via RESTful CRUD routes.
          </Typography>
        </Box>
      </Laptop>
